...
export const units: Unit[] = [
  ...
  { id: "first-tunes", level: 2, title: "First tunes", blurb: "The blues and a sixteen-bar tune, with the band." },
...
const ROOTLESS_HELD = { voicing: "rootless", reharm: "written", melody: "written", rhythm: "held" } as const;
const ROOTLESS_CHARLESTON = { voicing: "rootless", reharm: "written", melody: "written", rhythm: "charleston" } as const;
const SHELL_HELD = { voicing: "shell", reharm: "written", melody: "written", rhythm: "held" } as const;
const DROP2_ANTICIPATE = { voicing: "drop2", reharm: "written", melody: "written", rhythm: "anticipate" } as const;
const QUARTAL = { voicing: "quartal", reharm: "written", melody: "written", rhythm: "charleston" } as const;

function ex(
  partial: Omit<Exercise, "mastery" | "prerequisites" | "minutes" | "keys" | "tune"> &
    Partial<Pick<Exercise, "mastery" | "prerequisites" | "minutes" | "keys" | "tune">>,
): Exercise {
  return {
    keys: "all",
...
export const exercises: Exercise[] = [
  ...
  ex({ id: "st-louis-strain", title: "St. Louis strain", kind: "tune", level: 3, unit: "changes", blurb: "The blues with the IV in bar two.", tune: "st-louis-strain", generate: tune("st-louis-strain", 3), prerequisites: ["bb-blues"], mastery: { accuracy: ALL_ACC, bpm: 120 }, minutes: 5 }),
  ex({ id: "ja-da-changes", title: "Ja-Da changes", kind: "tune", level: 3, unit: "changes", blurb: "A7 D7 G7, the first cycle of dominants.", tune: "ja-da-changes", generate: tune("ja-da-changes", 3), prerequisites: ["turnaround"], mastery: { accuracy: ALL_ACC, bpm: 140 }, minutes: 5 }),
  ex({ id: "indiana-changes", title: "Indiana changes", kind: "tune", level: 3, unit: "changes", blurb: "Thirty-two bars of moving dominants.", tune: "indiana-changes", generate: tune("indiana-changes", 3), prerequisites: ["ja-da-changes"], mastery: { accuracy: ALL_ACC, bpm: 150 }, minutes: 7 }),
  ...
  ex({ id: "altered-dominants", title: "Altered dominants", kind: "drill", level: 4, unit: "minor", blurb: "7b9 and the dominant with a #11, rootless.", generate: (k) => chordDrill(["7", "dim7", "m6"], "rootless", k), prerequisites: ["minor-ii-v-i"] }),
  ex({ id: "minor-blues", title: "Minor blues", kind: "tune", level: 4, unit: "minor", blurb: "Twelve bars in minor, with the Ab7 to G7.", tune: "minor-blues", generate: tune("minor-blues", 4), prerequisites: ["minor-ii-v-i"], mastery: { accuracy: ALL_ACC, bpm: 130 }, minutes: 5 }),
  ...
  ex({ id: "autumn-changes", title: "Autumn changes", kind: "tune", level: 4, unit: "colour", blurb: "Major and minor ii-V-I side by side.", tune: "autumn-changes", generate: tune("autumn-changes", 4), prerequisites: ["minor-ii-v-i", "drop2-forms"], mastery: { accuracy: ALL_ACC, bpm: 140 }, minutes: 8 }),
  ...
  ex({ id: "scale-blues", title: "Blues scale", kind: "drill", level: 5, unit: "lines", blurb: "Six notes that work over the whole blues.", generate: (k) => scaleDrill("blues", k), prerequisites: ["major-scale"], mastery: { accuracy: ALL_ACC, bpm: 120 } }),
  ...
  ex({ id: "improv-f-blues", title: "Improvise over the blues", kind: "improv", level: 5, unit: "improv", blurb: "Blues scale and chord tones over twelve bars.", tune: "f-blues", generate: tune("f-blues", 5), prerequisites: ["scale-blues", "improv-ii-v-i"], mastery: { accuracy: 0.8, bpm: 130 }, minutes: 6 }),
  ...
  ex({ id: "improv-autumn", title: "Improvise over Autumn changes", kind: "improv", level: 5, unit: "improv", blurb: "Thirty-two bars, major and minor.", tune: "autumn-changes", generate: tune("autumn-changes", 5), prerequisites: ["improv-jazz-blues", "autumn-changes"], mastery: { accuracy: 0.8, bpm: 150 }, minutes: 8 }),
  ...
  ex({ id: "iii-vi-ii-v", title: "iii-VI7-ii-V7", kind: "progression", level: 6, unit: "advanced", blurb: "The rhythm changes bridge, with altered dominants.", generate: (k) => progressionDrill(PROGRESSIONS["iii-vi-ii-v"], k, QUARTAL), prerequisites: ["quartal-forms", "altered-dominants"], mastery: { accuracy: ALL_ACC, bpm: 160 }, minutes: 4 }),
  ex({ id: "rhythm-changes", title: "Rhythm changes", kind: "tune", level: 6, unit: "advanced", blurb: "Two chords a bar at tempo.", tune: "rhythm-changes", generate: tune("rhythm-changes", 6), prerequisites: ["iii-vi-ii-v", "indiana-changes"], mastery: { accuracy: ALL_ACC, bpm: 200 }, minutes: 8 }),
  ex({ id: "improv-rhythm-changes", title: "Improvise over rhythm changes", kind: "improv", level: 6, unit: "advanced", blurb: "The bridge is four dominants. The A sections move every two beats.", tune: "rhythm-changes", generate: tune("rhythm-changes", 6), prerequisites: ["rhythm-changes", "improv-autumn"], mastery: { accuracy: 0.8, bpm: 200 }, minutes: 8 }),
